...
def main(seed_):
    ...
    rf.fit(train_ppm_features, train_ppm_y)
    pred = rf.predict(test_ppm_features)
...
pd.DataFrame(result).to_csv('../../test_results/features/ppm_rf.csv', header = True, index = False)
wandb.finish()